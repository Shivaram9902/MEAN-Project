 ...
 * </pre>
 *
 * The above is a convenient shortcut equivalent to specifying your views explicitly with the {@link ui.router.state.$stateProvider#methods_state `views`}
 ...
 *
 * Example usage of $resolve in a views template
 * <pre>
 * $stateProvider.state('home', {
    ...
    compile: function (tElement, tAttrs, $transclude) {
      return function (scope, $element, attrs) {
        ...
        function updateView(firstTime) {
          ...
          /**
           * @ngdoc event
           * @name ui.router.state.directive:ui-views#$viewContentLoading
           ...
           *
           * @param {Object} event Event object.
           * @param {string} viewName Name of the views.
           */
